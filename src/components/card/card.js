function Card({title, year, imbdRating: rating, smallPoster: poster, trailer}){
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p className="card-text d-flex flex-column flex-md-row flex-wrap justify-content-around">
            <a className="movie__trailer-link m-1 m-xl-0 btn btn-outline-primary btn-sm" href={trailer} target="_blank" rel="noreferrer">Watch trailer</a>
